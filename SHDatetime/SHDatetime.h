...
bool tryCreateDate(long year,int month,int day,int timezoneOffset,double *ans,int *error);
...
bool tryAddDaysToTimestamp(double timestamp,long day,TimeAdjustOptions options,
